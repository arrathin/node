...
ChildProcess.prototype.spawn = function(options) {
  ...
  if (process.platform === 'os390') {
    ...
    if (process.env._BPXK_AUTOCVT)
      options.envPairs.push('_BPXK_AUTOCVT=' + process.env._BPXK_AUTOCVT);
    if (process.env._CEE_RUNOPTS)
      options.envPairs.push('_CEE_RUNOPTS=' + process.env._CEE_RUNOPTS);
    if(process.env._TAG_REDIR_ERR)
      options.envPairs.push('_TAG_REDIR_ERR=' + process.env._TAG_REDIR_ERR);
    if (process.env._TAG_REDIR_IN)
     options.envPairs.push('_TAG_REDIR_IN=' + process.env._TAG_REDIR_IN);
    if (process.env._TAG_REDIR_OUT)
      options.envPairs.push('_TAG_REDIR_OUT=' + process.env._TAG_REDIR_OUT);
    if (process.env.STEPLIB)
      options.envPairs.push('STEPLIB=' + process.env.STEPLIB);
    if (process.env.LIBPATH)
      options.envPairs.push('LIBPATH=' + process.env.LIBPATH);
  }
